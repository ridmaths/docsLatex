...
%% Tracé des fonctions
% Fonction
\psplot[linewidth=2.pt,linecolor=blue]{-5}{5}{(2/3)*x+1}
\rput[bl](-3.5,-1.7){\textcolor{blue}{$d$}}
% Fonction
\psplot[linewidth=2.pt,linecolor=red]{-5}{5}{-1.5*x+3.5}
\rput[bl](3.5,-1.5){\textcolor{red}{$d'$}}
\end{pspicture*}
\end{document}